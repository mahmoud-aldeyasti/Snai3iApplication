...
namespace Snai3i_BLL.Manager.Acountmanager
{
    public class AccountManager : IAccountManager
    {
        ...
        public async Task<GeneralResponse> RegisterUser(UserRegisterDto userRegisterDto)
        {
        ...
        public async Task<GeneralResponse> RegisterWorker(WorkerRegisterDto WorkerRegisterDto)
        {
            var worker = new User();
            ...
            IdentityResult result = await _userManager.CreateAsync(worker, WorkerRegisterDto.password);
